    ...
    if len(message.text) > 7:
        for i in range(1):
            ...
            if (len(argument) == 5 )or (len(argument) == 4):
                ...
                if (SECONDS == 0):
                    return
                notification_msg = await message.reply(f"<b>📌Note - This file will be  deleted in {get_exp_time(SECONDS)}. Please save or forward it to your saved messages before it gets deleted.</b>")
